...
Foam::label Foam::multiWorldConnections::communicator(const edge& worlds)
{
...
bool Foam::multiWorldConnections::addConnection(const word& otherWorld)
{
    return addConnectionByName(otherWorld);
}


Foam::label Foam::multiWorldConnections::getCommunicatorById
(
...
Foam::label Foam::multiWorldConnections::getCommunicatorByName
(
...
Foam::label Foam::multiWorldConnections::getCommunicator
(
    const word& otherWorld
) const
{
    return getCommunicatorByName(otherWorld);
}
