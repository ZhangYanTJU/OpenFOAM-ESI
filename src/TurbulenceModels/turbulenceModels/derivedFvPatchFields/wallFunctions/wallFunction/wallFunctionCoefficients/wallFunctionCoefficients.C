...
{
    os.writeEntryIfDifferent<scalar>("Cmu", scalar(0.09), Cmu_);
    os.writeEntryIfDifferent<scalar>("kappa", scalar(0.41), kappa_);
    os.writeEntryIfDifferent<scalar>("E", scalar(9.8), E_);
}
