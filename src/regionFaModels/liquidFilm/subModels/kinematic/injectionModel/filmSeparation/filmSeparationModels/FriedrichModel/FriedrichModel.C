...
boolList FriedrichModel::calcCornerEdges() const
{
    boolList cornerEdges(mesh().nEdges(), false);
...
boolList FriedrichModel::calcSeparationFaces() const
{
    boolList separationFaces(mesh().faces().size(), false);
...
(
    const boolList& separationFaces
) const
{
...
tmp<scalarField> FriedrichModel::Fratio() const
{
    ...
    const boolList separationFaces(calcSeparationFaces());
