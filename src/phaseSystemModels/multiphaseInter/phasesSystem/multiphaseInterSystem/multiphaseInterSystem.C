...
Foam::multiphaseInterSystem::generatePhaseModels(const wordList& phaseNames) const
{
...
Foam::tmp<Foam::scalarField> Foam::multiphaseInterSystem::rho(const label patchI) const
{
    auto iter = phaseModels_.cbegin();
...
Foam::tmp<Foam::scalarField> Foam::multiphaseInterSystem::kappa(const label patchI) const
{
    auto iter = phaseModels_.cbegin();
...
Foam::tmp<Foam::scalarField> Foam::multiphaseInterSystem::mu(const label patchI) const
{
    auto iter = phaseModels_.cbegin();
...
Foam::tmp<Foam::scalarField> Foam::multiphaseInterSystem::nu(const label patchI) const
{
    auto iter = phaseModels_.cbegin();
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseInterSystem::kappaEff() const
{
    ...
    return
    (
        tmp<volScalarField>(new volScalarField(kappaEff))
    );
}
...
Foam::multiphaseInterSystem::kappaEff(const label patchi) const
{
    ...
    return
    (
        tmp<scalarField>(new scalarField(kappaEffp))
    );
}
...
const Foam::multiphaseInterSystem::phaseModelTable& Foam::multiphaseInterSystem::phases() const
{
    return phaseModels_;
}


Foam::multiphaseInterSystem::phaseModelTable& Foam::multiphaseInterSystem::phases()
{
    return phaseModels_;
}
...
Foam::multiphaseInterSystem::phasePairTable& Foam::multiphaseInterSystem::totalPhasePairs()
{
    return totalPhasePairs_;
}
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseInterSystem::nearInterface() const
{
