...
Foam::label& Foam::glTF::bufferView::buffer()
{
    return buffer_;
}


Foam::label& Foam::glTF::bufferView::byteOffset()
{
    return byteOffset_;
}


Foam::label& Foam::glTF::bufferView::byteLength()
{
    return byteLength_;
}


Foam::label& Foam::glTF::bufferView::target()
{
    return target_;
}
