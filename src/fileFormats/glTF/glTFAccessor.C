...
Foam::label& Foam::glTF::accessor::bufferViewId()
{
    return bufferViewId_;
}


Foam::label& Foam::glTF::accessor::byteOffset()
{
    return byteOffset_;
}


Foam::label& Foam::glTF::accessor::componentType()
{
    return componentType_;
}


Foam::label& Foam::glTF::accessor::count()
{
    return count_;
}


Foam::string& Foam::glTF::accessor::type()
{
    return type_;
}
