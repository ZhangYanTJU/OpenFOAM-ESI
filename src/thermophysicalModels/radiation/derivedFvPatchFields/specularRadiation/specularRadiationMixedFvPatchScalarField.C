...
) const
{
    ...
    // Find the neighbouring ray indices of
    // the reflected ray in the east and west
    // Go to the east
    ...
    // Find the ray index closest to the
    // reflected ray in the azimuthal direction
    label azimuthRayi = -1;
    bool east = false;
    ...
    // Find the neighbouring ray indices of
    // the reflected ray in the north and south
    // Go to the north
    ...
    // Find the ray index closest to the
    // reflected ray in the polar direction
    label polarRayi = -1;
    ...
    // Find the ray index neighbouring
    // the azimuthal and polar neighbour rays
    label cornerRayi = -1;
    if (polarRayi != -1)
    {
        if (east)
    ...
    // Interpolate the ray intensity of the reflected
    // complementary ray from the neighbouring rays
