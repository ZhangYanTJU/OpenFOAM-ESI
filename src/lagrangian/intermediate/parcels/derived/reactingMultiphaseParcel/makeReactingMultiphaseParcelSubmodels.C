...
makeReactingParcelCloudFunctionObjects(reactingMultiphaseCloud);
...
// Reacting sub-models
makeReactingMultiphaseParcelCompositionModels(reactingMultiphaseCloud);
...
// MPPIC sub-models
makeMPPICParcelDampingModels(reactingMultiphaseCloud);
makeMPPICParcelIsotropyModels(reactingMultiphaseCloud);
makeMPPICParcelPackingModels(reactingMultiphaseCloud);
