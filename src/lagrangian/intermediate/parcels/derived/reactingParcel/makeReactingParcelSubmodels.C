...
makeReactingParcelCloudFunctionObjects(reactingCloud);
...
// MPPIC sub-models
makeMPPICParcelDampingModels(reactingCloud);
makeMPPICParcelIsotropyModels(reactingCloud);
makeMPPICParcelPackingModels(reactingCloud);
